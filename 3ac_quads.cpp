...
OpenQuad::OpenQuad(Opd * handleIn, std::string pathIn, bool readOnlyIn) 
...
std::string BinOpQuad::oprString(BinOp opr){
    ...
    //come back to this
	throw new InternalError("Unknown BinOp");
